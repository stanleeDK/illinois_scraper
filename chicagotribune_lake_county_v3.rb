...
# GLOBAL VARIABLES 
city 			= "Lake" 		# county to scrape - get full list here: http://chicagotribune.public-record.com/realestate/
pageCount 		= 474			# The last page number of the county you want to scrape - must be greater than 2
