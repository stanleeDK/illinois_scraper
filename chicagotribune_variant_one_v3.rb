...
# GLOBAL VARIABLES 
city 			= "DuPage" 		# county to scrape - get full list here: http://chicagotribune.public-record.com/realestate/
pageCount 		= 504			# The last page number of the county you want to scrape - must be greater than 2
				...
				# EARL R SHUMAKER
		 		...
		 		if cells.length > 0 
					...
					# </td>
		 			...
		 			f.puts soldto
		 			f.puts sold_at
			 		f.puts "INSERT INTO " + cityP + "(sold_to,street_address,city,zip,value,sold_at) VALUES ('" + soldto.to_s  + "','" + street_address.to_s + "','" +  city + "','" +  zip + "','" + value.to_s + "','" + sold_at + "')"
			 		f.puts "-----"
